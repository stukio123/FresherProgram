...
public class Client {
	...
	public Client(String firstName, String lastName, String gender, String country, String maritalStatus,
	...
	public String toString() {
		...
		builder.append("[ClientEntity] - ");
		builder.append("Id: " + this.clientID);
